...
<div class="container-fluid">
	<div class="xyz">
		...
		<div id="containerScore" style="width:98%; margin:0 auto;">
			...
			out.print(sc.getScoreTableByRound(r.getrId()));
		%>
		</div>
<!-- 		<div class="col-sm-offset-1 col-sm-10"> -->
<!-- 			<button type="button" id="btnDetermineWinners" class="btn btn-primary col-sm-1 "> -->
<!-- 				Update Winners -->
<!-- 			</button> -->
<%-- 			<% --%>
// 			out.print("<input type=\"hidden\"id=\"rId\" value=\"" + r.getrId() + "\">");
<%-- 			%> --%>
